...
export class NetworkService {
  ...
  private getNetworkTestRequest(): Observable<any> {
    // return this.http.get('http://localhost/setvmas/api/FactoresBonificacionVentas');
    //  return this.http.get('https://setvmas.com/SetVMasFinal/api/FactoresBonificacionVentas');
    return this.http.get('https://setvmas.com/api/api/Banners/Tipo/Inferior');
  }
