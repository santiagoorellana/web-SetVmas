...
/****** Object:  StoredProcedure [dbo].[USP_DesBoni_Referido]    Script Date: 23/7/2020 22:55:19 ******/
SET ANSI_NULLS ON
GO
...
-- Parámetros			: 
---- ===================================================================================== ----
ALTER PROCEDURE [dbo].[USP_DesBoni_Referido]
(
...
/*asignar bonificacion al referido*/
	 ...
	 BEGIN
	SELECT @id=Usuario.UsuarioId, @puntos=Usuario.Puntos, @anfitrion=Usuario.Anfitrion, @claseNombre=ClasesUsuarios.Nombre,
